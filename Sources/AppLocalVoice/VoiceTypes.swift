...
public struct SpeechConfiguration: Sendable, Equatable {
    ...
    /// Preserve newline-delimited caller-prepared PCM speech units in one
    /// continuous request instead of applying the short first-chunk split. The 240 UTF-16 safety ceiling and host
